...
data class Drink(
    ...
    /**
     * retourne la liste des paires (ingrédient, mesure) non-vides
     * zip() combine les 2 listes par index : [a,b] zip [1,2] = [(a,1),(b,2)]
     * filter = garde uniquement les ingrédients non null/vides
     * map = transforme les nulls en chaînes vides pour l'affichage
     */
